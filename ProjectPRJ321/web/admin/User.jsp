    ...
    <body>
        <header>
            <div class="header">
                ...
                <div class="header-right">
                    ...
                    <a href="AddProduct.jsp">AddNew</a>
                </div>
            </div>
        </header>
           ...
           <%
            ...
            List<Account> lst = b.getAllAccount();
        ...
        <div class="table-wrapper">
            <table class="fl-table">
                ...
                %>
                <tr>
                    <td><a href="AccountBill.jsp?name=<%=x.getUsername()%>"><%=x.getUsername() %></a></td>
